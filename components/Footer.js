...
export default function Footer() {
  return (
    <footer className="site-footer" role="contentinfo" aria-label="تذييل الموقع">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <div className="social">
            ...
            <a href="https://t.me/mahmoud_a_hamyd" target="_blank" rel="noopener noreferrer" aria-label="تليجرام"><i className="fab fa-telegram-plane"></i></a>
        ...
        <div className="footer-col">
          ...
          <a href="https://maps.app.goo.gl/inYTfr9Js78JwXqx5" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer-when-cross-origin"><i className="fas fa-map-marker-alt" style={{ marginLeft: '6px', opacity: 0.3 }}></i> الموقع الجغرافي</a>
        </div>
      </div>
