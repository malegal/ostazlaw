        ...
        <div className="hero-inner">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-text reveal" style={{ transitionDelay: '0.15s' }}>
              <p><strong>مكتب محاماة مقره أسوان، ويخدم الأفراد والشركات والمستثمرين في مختلف محافظات مصر. يقوده الأستاذ محمود عبد الحميد جاد الرب. نؤمن بأن العمل القانوني المتميز يبدأ بالفهم العميق، ويُبنى على التخطيط، ويُقاس بحماية مصالح العميل.</strong></p>
