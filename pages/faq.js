...
const faqItems = [
  ...
  { q: 'ما الذي أحتاج إلى إرساله قبل طلب الاستشارة؟', a: 'يكفي إرسال ملخص واضح للوقائع وتحديد المطلوب. ويمكن إرفاق المستندات الأساسية إن وجدت، مع عدم إرسال مستندات حساسة غير ضرورية قبل توجيهك إلى القناة المناسبة.' },
  { q: 'هل يشترط إرسال مستندات لبدء التواصل؟', a: 'لا يشترط إرسال مستندات لبدء التواصل. يكفي في البداية إرسال الاسم ووسيلة التواصل وملخص مختصر للمسألة، ويمكن إرفاق المستندات إذا كانت ستساعد على فهم الموضوع.' },
  { q: 'هل يمكن طلب استشارة قبل رفع دعوى؟', a: 'نعم، وتساعد الاستشارة السابقة على رفع الدعوى في تقييم الموقف القانوني ومعرفة البدائل والمستندات والخطوات المطلوبة قبل اتخاذ القرار.' },
  ...
  { q: 'هل يحافظ المكتب على سرية بيانات العملاء؟', a: 'نعم، يلتزم المكتب بالحفاظ على سرية المعلومات والمستندات التي يتم استلامها في إطار العمل المهني، ولا تُستخدم بيانات العملاء لأغراض دعائية دون موافقة مناسبة.' },
  { q: 'كيف تتم متابعة قضيتي مع المكتب؟', a: 'تتم متابعة مستجدات القضية حاليًا عن طريق موقع المكتب، من خلال صفحة «تابع ملفك القانوني» وإدخال البيانات المطلوبة. كما نعمل على تطوير تطبيق مخصص لعملاء المكتب يساعدهم على متابعة مستجدات قضاياهم بصورة أكثر سهولة وتنظيمًا.' },
  { q: 'هل يمكنني متابعة ملفي القانوني إلكترونيًا؟', a: 'نعم، يمكنك استخدام صفحة «تابع ملفك القانوني» على الموقع وإدخال البيانات المطلوبة. وفي حال عدم ظهور المعلومات أو الحاجة إلى مساعدة، يُرجى التواصل مع المكتب عبر القنوات الرسمية.' },
  ...
  { q: 'هل يمثل المكتب الأفراد والشركات والمستثمرين؟', a: 'نعم، يقدم المكتب خدماته للأفراد والشركات والمستثمرين ورجال الأعمال، بحسب طبيعة الموضوع ودرجة التعقيد والمسار القانوني المطلوب.' },
  { q: 'هل يقدم المكتب خدمات في مسائل الأحوال الشخصية؟', a: 'نعم، يتعامل المكتب مع مسائل الأحوال الشخصية والحقوق الأسرية والإجراءات المرتبطة بها، ومنها الطلاق والخلع والفسخ والنفقة والحضانة والرؤية والميراث والتركات، وفق طبيعة كل حالة ووقائعها ومستنداتها.' },
  ...
  { q: 'هل يمكن تحديد موعد لمقابلة المكتب؟', a: 'نعم، يمكنك اختيار طلب مقابلة في المكتب وتحديد الوقت الأنسب لك. ويظل الموعد المقترح غير مؤكد إلى أن يتم تأكيده برسالة عبر واتساب أو وسيلة التواصل المعتمدة.' },
