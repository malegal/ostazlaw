...
// أسئلة عملية تساعد الزائر على فهم الخطوة التالية قبل التواصل مع المؤسسة، دون وعود بنتيجة قضائية محددة.
const faqItems = [
  ...
  { q: 'هل تحافظ المؤسسة على سرية بيانات العملاء؟', a: 'نعم، تلتزم المؤسسة بالحفاظ على سرية المعلومات والمستندات التي يتم استلامها في إطار العمل المهني، ولا تُستخدم بيانات العملاء لأغراض دعائية دون موافقة مناسبة.' },
  ...
  { q: 'هل يمكنني متابعة ملفي القانوني إلكترونيًا؟', a: 'إذا كانت خدمة المتابعة الإلكترونية مفعلة لملفك، يمكنك استخدام صفحة «تابع ملفك القانوني» وإدخال البيانات المطلوبة. وفي حال عدم ظهور المعلومات، يُرجى التواصل مع المؤسسة عبر القنوات الرسمية.' },
  { q: 'هل تمثل المؤسسة الأفراد والشركات؟', a: 'نعم، تقدم المؤسسة خدماتها للأفراد والشركات والمستثمرين، بحسب طبيعة الموضوع ودرجة التعقيد والمسار القانوني المطلوب.' },
