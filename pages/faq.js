...
const faqItems = [
  ...
  { q: 'هل يمكنني متابعة حالة قضيتي إلكترونيًا؟', a: 'إذا كانت خدمة المتابعة الإلكترونية مفعلة لملفك، يمكنك استخدام صفحة «تابع قضيتك» وإدخال البيانات المطلوبة. وفي حال عدم ظهور المعلومات، يُرجى التواصل مع المؤسسة عبر القنوات الرسمية.' },
