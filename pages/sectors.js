...
export default function Sectors() {
  return (
    <Layout>
      <Head>
        {/* SEO/AEO: العنوان والوصف يستهدفان خدمات الأفراد والشركات والمستثمرين في أسوان؛ يجب تحديثهما مع أي تغيير جوهري في نطاق العمل. */}
      ...
      {/* كل بطاقة تمثل جمهورًا مختلفًا، وروابطها تمرر audience وspecialty إلى نموذج التواصل لتقليل الاحتكاك عند طلب الاستشارة. */}
