// مصدر Schema موحد للمؤسسة؛ يُستخدم في التخطيط العام حتى تبقى بيانات الكيان والعنوان متسقة.
export const SITE_URL = 'https://ostazlaw.vercel.app';
export const SITE_NAME = 'مؤسسة جاد الرب للمحاماة والاستشارات القانونية';
...
export const ORGANIZATION_SCHEMA = {
  ...
  description: 'مؤسسة قانونية مصرية مقرها أسوان، تقدم الاستشارات والتمثيل القانوني وصياغة العقود للأفراد والشركات في أسوان ومختلف محافظات مصر بحسب طبيعة الخدمة والقضية.',
  url: `${SITE_URL}/`,
  image: OG_IMAGE,
